...
date: '2020-11-05T13:19:05.705Z'
image: https://wp.mrkhosravian.ir/wp-content/uploads/2021/11/pascals-triangle-types.jpg
excerpt: how to solve pascal triangle with java
---
        ...
        for (int line = 1; true; line++) {
            ...
            for (int i = 1; i<= line; i++) {
                ...
                element = element.multiply(
                  BigInteger.valueOf(line - i)).divide(BigInteger.valueOf(i)
                );
