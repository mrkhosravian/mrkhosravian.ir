...
export default function Custom404() {
  ...
  return (
        <Base>
          <div
            className="h-screen w-screen bg-gray-100 dark:bg-gray-800 flex justify-center items-center">
            <div
              className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700 max-w-3xl">
              <div className="max-w-md">
                <div className="text-5xl font-dark dark:text-white font-bold">404
                </div>
                <p
                  className="text-2xl md:text-3xl font-light dark:text-white leading-normal mb-10"
                >{t("404")}</p>
              ...
              <div className="max-w-lg w-64 md:w-96">
                <svg id="Layer_1" data-name="Layer 1"
                     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800">
                  ...
                  <ellipse className="cls-2" cx="748.2" cy="816.89" rx="202.22"
                           ry="30.98"
                  ...
                  <ellipse className="cls-7" cx="1452.5" cy="998.5" rx="153"
                           ry="117" />
